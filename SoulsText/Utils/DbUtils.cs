...
namespace SoulsText.Utils
{
    ...
    public class DbUtils
    {
        ...
        /// <summary>
        /// Get an int? from a data reader object and gracefully handle NULL values.
        /// </summary>
        /// <param name="reader">A SqlDataReader that has not exhausted its result set</param>
        /// <param name="column">The name of the column from the result set referenced to by the reader</param>
        /// <returns>The value of the given column or null.</returns>
        ...
        /// <summary>
        /// Get a float from a data reader object.
        /// </summary>
        /// <param name="reader">A SqlDataReader that has not exhausted its result set</param>
        /// <param name="column">The name of the column from the result set referenced to by the reader</param>
        /// <returns>The value of the given column.</returns>
        ...
        {
            return (float)reader.GetDouble(reader.GetOrdinal(column));
        }
